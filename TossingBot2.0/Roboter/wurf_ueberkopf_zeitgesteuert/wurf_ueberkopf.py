...
def main():
    ...
    try:
        ...
        waypoints = [
            ...
            # {
            #     'positions': [184.76, -68.18, 119.06, 10.41, 96.16, 0],  # Point C in degrees
            #     'wait_time': 0,  # Wait 1 second at point C
            #     'duration': 1.5    # Take 1.5 seconds to reach point C
            # },
            {
                'positions': [180, -140, 43, 8, 97, 0],  # Point D in degrees
                'wait_time': 0.45,  # Wait 2 seconds at point D
                'duration': 0.45,   # Take 0.5 seconds to reach point D for maximum throwing speed
            }
        ]
