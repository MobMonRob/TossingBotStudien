        ...
        waypoints = [
            {
                ...
                'wait_time': 2.0,  # Wait 2 seconds at point A
            ...
            },
            {
                ...
                'wait_time': 1.2,  # Wait 2 seconds at point D
                'duration': 0.5,   # Take 0.5 seconds to reach point D for maximum throwing speed
                # Geschwindigkeit für jeden Gelenkwinkel in rad/s
                #'velocities': [max_velocity, max_velocity, max_velocity, max_velocity, max_velocity, max_velocity],
                # Beschleunigung für jeden Gelenkwinkel in rad/s²
                #'accelerations': [4.0, 4.0, 4.0, 4.0, 4.0, 4.0]
            }
        ]
