...
WAYPOINTS = [
    {'positions': [0.77, -43.34, 92.68, 36.16, 90.4, 0],   'wait_time': 1.0, 'duration': 1.5},
    ...
    {'positions': [26.16,  -50.06,  42.96, 13.88, 100.40, 0], 'wait_time': 2.0, 'duration': 0.5},
    {'positions': [0.77, -43.34, 92.68, 36.16, 90.4, 0],   'wait_time': 1.0, 'duration': 1.5},
]
RELEASE_TARGET = [42.96, -50.06, 26.16, 13.88, 100.4, 0.0]
...
def main():
    ...
    rclpy.init()
    node = UR5eBaseController('wurf_seite_positionsgesteuert',
                               gripper_ip=args.ip, gripper_port=args.port)
    node.execute_waypoint_sequence(WAYPOINTS, release_target_deg=RELEASE_TARGET)
